        ...
        <div class="px-4 py-5 sm:p-6">
            <form action="{{ route('students.index') }}" method="GET" class="space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-4">
                        <label for="student_id_search" class="block text-sm font-medium text-gray-700">Search Student ID</label>
                        <div class="search-container">
                            <input type="text"
                                ...
                                autocomplete="off"
                                onkeyup="handleSearch(this, 'student_id', 'student_id_results')"
                                onkeydown="handleKeyNavigation(event, 'student_id_results')"
                                onfocus="showResults('student_id_results')"
                                onblur="hideResults('student_id_results')" />
                            <div id="student_id_results" class="search-results"></div>
                        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-4">
                        <label for="email_search" class="block text-sm font-medium text-gray-700">Search Email</label>
                        <div class="search-container">
                            <input type="text"
                                id="email_search"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                                ...
                                autocomplete="off"
                                onkeyup="handleSearch(this, 'email', 'email_results')"
                                onkeydown="handleKeyNavigation(event, 'email_results')"
                                onfocus="showResults('email_results')"
                                onblur="hideResults('email_results')" />
                            <div id="email_results" class="search-results"></div>
                        </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        const types = ['student_id', 'first_name', 'last_name', 'email'];
        types.forEach(type => {
    ...
    function resetFilters() {
        ...
        ['student_id', 'first_name', 'last_name', 'email'].forEach(type => {
