...
<div class="container mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="bg-white shadow overflow-hidden sm:rounded-lg">
        ...
        <div class="px-4 py-5 sm:p-6">
            <form action="{{ route('teachers.index') }}" method="GET" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                <div>
                    <label for="teacher_id" class="block text-sm font-medium text-gray-700">Teacher ID</label>
                    <input type="text" name="teacher_id" id="teacher_id" value="{{ request('teacher_id') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="e.g. TCH00001" />
                </div>
                <div>
