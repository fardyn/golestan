...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <h1 class="text-3xl font-bold text-gray-900 mb-8">Welcome to Golestan</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5">
                                ...
                                <p class="mt-1 text-sm text-gray-500">Manage university courses</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- Offerings Card -->
            <a href="{{ route('offerings.index') }}" class="block">
                <div class="bg-white overflow-hidden shadow-sm rounded-lg hover:shadow-lg transition-shadow duration-300">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5">
                                <h3 class="text-lg font-medium text-gray-900">Offerings</h3>
